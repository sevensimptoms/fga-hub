...
const email_template_1 = __importDefault(require("../models/email-template")); // Import your EmailTemplate model
const nodemailer = require('nodemailer');
class EmailService {
    constructor() {
        // General sendEmail function
        this.sendEmail = async (data) => {
